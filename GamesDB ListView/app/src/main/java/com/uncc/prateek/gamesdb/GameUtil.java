...
public class GameUtil {
    ...
    static public class GamesSAXParser extends DefaultHandler {
        ...
        static ArrayList<Game> getSearchList(InputStream xmlIn) {
            String URLBase = "http://thegamesdb.net/api/GetGame.php?id=";
            String URL = "";
            ArrayList<Game> searchList = null;
            try {
                searchList = GamesSAXParser.parseGamesData(xmlIn);
                ArrayList<Game> temp = new ArrayList<Game>();
                for (int x = 0; x <= 12; x++) {
                    temp.add(searchList.get(x));
                }
                for (int k = 0; k < temp.size(); k++) {
                    Game game = temp.get(k);

                    URL url = new URL(URLBase + game.getId());
                    ...
                    if (statusCode == HttpURLConnection.HTTP_OK) {
                        ...
                        game = GamesLogoSAXParser.parseShortGameDetails(in);
                        searchList.set(k, game);
                    }
                }
        ...
        public void startElement(String uri, String localName, String qName,
            ...
            if (localName.equals("Game")) {
                Log.d(logText, "Game obj created");
                newGame = new Game();
                count++;
            }
        }
        ...
        static public class GamesLogoSAXParser extends DefaultHandler {
            private static String URLBase = "http://thegamesdb.net/api/GetGame.php?id=";
            ...
            static Game parseShortGameDetails(InputStream xmlIn) throws IOException, SAXException {
                GamesLogoSAXParser parser = new GamesLogoSAXParser();
                Xml.parse(xmlIn, Xml.Encoding.UTF_8, parser);
            ...
            public void endElement(String uri, String localName, String qName)
                ...
                if (xmlText == null) {
                    ...
                    } else if (localName.equals("clearlogo") || qName.equals("clearlogo")) {
                        //images.add(baseImgUrl + xmlText);
                        newGame.setClearLogo(baseImgUrl + xmlText);
                        Log.d(logText, "Clearlogo: " + baseImgUrl + xmlText);
        ...
        public void endElement(String uri, String localName, String qName)
            ...
            if (xmlText == null) {
                ...
                if (localName.equals("id")) {
                    ...
                    Log.d(logText, "clearlogo set " + baseImgUrl + xmlText);
                    newGame.setClearLogo(baseImgUrl+xmlText);
