...
public class AsyncGetChannels extends AsyncTask<String, Void, ArrayList<Channel>> {

    private String token;
    IContextChannel context;
    ArrayList<Channel> channelList = new ArrayList<Channel>();

    public AsyncGetChannels(IContextChannel context) {
    ...
    protected ArrayList<Channel> doInBackground(String... string) {
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context.getContext());
    ...
    protected void onPostExecute(ArrayList<Channel> list) {
        ...
        context.onChannelsCall(list);

    }


    static interface IContextChannel{
