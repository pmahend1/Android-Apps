...
public class DealsRVGridAdapter extends RecyclerView.Adapter<DealsRVGridAdapter.ViewHolder> {

        private ArrayList<Deal> mDataset;
    private Context mContext;
    dealConntector1 dealConntectorObj;
    ...
    public DealsRVGridAdapter(Context context , dealConntector1 dealIface, ArrayList<Deal> dealsList) {
        mDataset = dealsList;
        mContext = context;
    ...
    public static interface dealConntector1{
